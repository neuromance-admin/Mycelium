...
1. `System/VaultIdentity.md` — write with this structure:
   ...
   - Protocol Version: 1.0
   - Spore Version: 0.5.1c
   - upgradedAt: [today] (v0.5.1c)
...
8. `_Spore-v0.5.1c.md` — runtime (from Runtime Payload below)
9. `_Spore-VMD-Toolset.v0.5.1c.md` — toolset (from Toolset Payload below)

Read back every file after writing. Do not proceed if any read-back fails.

### Step 5 — Completion Message

> *"Your Mycelium environment is ready. VMD ID: MYC-YYYYMMDD-XXXXXX. [N] nodes initialised. Running Spore-v0.5.1c. Your persona files live at MyceliumPersonas/ and will be shared across all your vaults. Open a new conversation, point it at this vault, and paste `_Spore-v0.5.1c.md` as your first message to begin."*
...
> Write this exactly to vault root as `_Spore-v0.5.1c.md` during installation.
...
> Write this exactly to vault root as `_Spore-VMD-Toolset.v0.5.1c.md` during installation.
> Do not modify the payload. Copy exactly.
